...
function wakeUp() {
  console.log(
    `Wake up ${this.name}! Congratulations! You are not russian. You are ${this.nationality}.`
  );
}
function fallAsleep() {
  console.log(
    `${this.name}! It's time to fall asleep! It's already night time in ${this.country}!`
  );
}
